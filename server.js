...
const app = express()
// takes care of cors errors when using API on client side
...
// API request and what to respond with 
app.use('/api/:alienName',(request,response) => {
...
// Where to initialize the server on local host and heroku 
